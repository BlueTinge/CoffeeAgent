...
response[231] = {0: ['My coffee is good too, @a. Only @p.', 'That coffee sounds good, but is it as good as my coffee? After all, for @p, @a', 'But would you like to try my coffee? I will sell it to you for @p. I think you would, since @a'], 1: []}
